...
| 6 | **Copy-prompt button in the Gallery lightbox**, next to Remix. Remix reuses a prompt in-app; Copy gets it OUT — into Palette, a chat, notes. Check-mark flash confirms. | ~15 | (this commit) |
