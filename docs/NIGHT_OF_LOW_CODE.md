...
| 4 | Gen Space now shows the **hot/cold warmth pill** when a local video model is selected — same honest residency story the Playground got. A cold engine costs ~5-15 min of load before the render; Gen Space was the one surface that still hid that. | ~13 | (this commit) |
