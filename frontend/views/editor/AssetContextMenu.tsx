...
export function AssetContextMenu({
  ...
  return (
    ...
    >
      {isMulti && (
        <div className="px-3 py-1 text-[10px] text-amber-400 font-medium">
      ...
      {isMulti && (
        <>
          ...
          <button
            ...
            className="w-full text-left px-3 py-1.5 text-amber-300 hover:bg-zinc-700 flex items-center gap-3"
          >
