...
export interface MenuDepsParams {
  ...
  handleMakeCaptionsKaraoke: () => void
  ...
  return [
    ...
    // Timeline-level: add tracks, add layers, add text/captions, snapping
    {
      ...
      items: [
        ...
        { id: 'make-captions-karaoke', label: 'Make Karaoke Captions (Word Pop)', action: () => p.handleMakeCaptionsKaraoke() },
    ...
    // ── Help ──
    {
      ...
      items: [
        ...
        { id: 'about', label: "About Director's Desktop", action: () => window.dispatchEvent(new CustomEvent('open-settings', { detail: { tab: 'about' } })) },
      ],
    },
  ]
}
