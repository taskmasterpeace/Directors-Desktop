...
export const TEXT_PRESETS: TextPreset[] = [
  ...
  { id: 'lower-third-accent', name: 'Accent Lower Third', category: 'lower-thirds', style: { text: 'Speaker Name', fontSize: 28, fontWeight: '500', positionX: 8, positionY: 85, textAlign: 'left', color: '#FFFFFF', backgroundColor: 'rgba(43,97,255,0.85)', padding: 10, borderRadius: 4, maxWidth: 35 } },
...
export type ViewType = 'home' | 'project' | 'playground' | 'gallery' | 'characters' | 'styles' | 'references' | 'recipes' | 'wildcards' | 'prompt-library' | 'clip-tool'
